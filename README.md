...
# <u>Test codes for the MB1 and MB2 Master EAGLE course at the University of Wuerzburg, Germany.
The first __script__ corresponds to the project for the MB2 course Introduction to Programming and Geostatistics.<u>
