...
***
## [MB1](http://eagle-science.org/project/digital-image-analysis-and-gis/) course: *Project_QGIS_Script.R, Global SDG database, LandSat8_Script.R, LandSat 8, OTB toolbox, QGIS, and Map*
...
Because [LandSat 8](https://www.usgs.gov/land-resources/nli/landsat/landsat-8) images cannot show continuity on non-cloudy dates. An analysis of Radar [SLC](https://sentinel.esa.int/web/sentinel/user-guides/sentinel-1-sar/product-types-processing-levels/level-1) images of the [Sentinel 1](https://sentinel.esa.int/web/sentinel/missions/sentinel-1) satellite was also performed in the last year until the lake disappears. This occurs from April 2017 to April 2018 approximately. The images were processed using the free software [SNAP](https://step.esa.int/main/toolboxes/snap/) and then a quick analysis was made using [Project_Radar_Script.R](https://github.com/diegoalarc/Test__MB1_and_MB2/blob/master/Project_Radar_Script.R) in R.

It should be noted that all the information acquired through [LandSat 8](https://www.usgs.gov/land-resources/nli/landsat/landsat-8) and [Sentinel 1](https://sentinel.esa.int/web/sentinel/missions/sentinel-1), has small temporary empty spaces, which do not affect the observation of the drought of the Aculeo lagoon.
...
The __script__ that is called [Project_QGIS_Script.R](https://github.com/diegoalarc/Code_Test_MB2/blob/master/Project_QGIS_Script.R), [LandSat8_Script.R](https://github.com/diegoalarc/Test__MB1_and_MB2/blob/master/LandSat8_Script.R), and [Project_Radar_Script.R](https://github.com/diegoalarc/Test__MB1_and_MB2/blob/master/Project_Radar_Script.R). With these three scripts it was possible to obtain the images and charts that were used for the [QGIS](https://www.qgis.org/en/site/) project which corresponds to the [MB1 course Digital Image Analysis and GIS](http://eagle-science.org/project/digital-image-analysis-and-gis/) of the [Master EAGLE](http://eagle-science.org/) to create an explicative and visually attractive map.
...
#### Here you can see the charts for __LandSat 8__ and  __Sentinel 1__ that were generated by applying [RStudio](https://rstudio.com/) scripts for LandSat 8 and [SNAP](https://step.esa.int/main/toolboxes/snap/) for Sentinel 1.
...
#### Here you can see the final Map created to the approval of the [MB1](http://eagle-science.org/project/digital-image-analysis-and-gis/) course.

 - Click in the following link to download the final file in the complete resolution of the map ["Aculeo Lagoon TimeSeries drought map from 2010 - 2018"](https://github.com/diegoalarc/Code_Test_MB2/blob/master/Map_QGIS_Generated/QGIS_EAGLE_Msc.pdf).
