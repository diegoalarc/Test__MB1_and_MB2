...
### MB1 course: Created using the following [Project_QGIS_Script.R](https://github.com/diegoalarc/Code_Test_MB2/blob/master/Project_QGIS_Script.R) it was possible generated the information need it to elaborate the following map by [QGIS](https://www.qgis.org/en/site/):
